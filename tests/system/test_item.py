...
from models.item import StoreModel
    ...
    def test_create_item(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({'name': 'test', 'price': 18.99}, json.loads(response.data))
    ...
    def test_item_list(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({'items': [{'name': 'test', 'price': 5.99}]}, json.loads(response.data))